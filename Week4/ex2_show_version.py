...
version_input = show_version.split('\n')

router_dict = {}

for line in version_input:
    if 'Cisco IOS Software' in line:
        router_dict['vendor'] = line.split(',')[0]
        router_dict['os_version'] = line.split(',')[2]
    elif 'bytes of memory' in line:
        router_dict['model'] = line.split('processor')[0]
    elif 'Processor board ID' in line:
        router_dict['serial_number'] = line.split()[-1]
    elif ' uptime is ' in line:
        router_dict['uptime'] = line.split(None, 3)[3]
